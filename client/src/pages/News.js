        ...
        <div className="row1">
          ...
          <div className="slide-image">
            ...
            <div className="img-container first">
                <img src={news_img3} alt="news-image" className="student-image"/>
            </div>
            <div className="img-container">
                <img src={news_img1} alt="news-image" className="student-image"/>
            </div>
            <div className="img-container">
                <img src={news_img2} alt="news-image" className="student-image"/>
            </div>
            <div className="img-container">
                <img src="../img/pineapple6.jpeg" alt="news-image" className="student-image"/>
            </div>
